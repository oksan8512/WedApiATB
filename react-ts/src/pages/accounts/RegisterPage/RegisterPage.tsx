...
const RegisterPage = () => {
    ...
    return (
        <>
            <h1 className={"text-4xl font-extrabold dark:text-white text-center mb-8"}>Реєстрація</h1>
                ...
                <div className="flex items-center justify-center w-full mb-5">
                    <label htmlFor="dropzone-file"
                        ...
                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                            {form.image ?
                                <img src={URL.createObjectURL(form.image)} className={"w-16 h-16 mb-4 object-contain"} alt="salo"/>
                                :
                            ...
                            <p className="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                                className="font-semibold">Нажміть</span> для завантаження аватарки</p>
                        </div>
                        <input onChange={handlerImageChange} id="dropzone-file" type="file" className="hidden"/>
                    </label>
                </div>
